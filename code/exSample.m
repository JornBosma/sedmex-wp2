...
text(200, 83, ['D_{90} = ',num2str(D90, 4),' μm'], 'FontSize',fontsize*.9)
text(96, 43.5, ['D_{50} = ',num2str(D50, 3),' μm'], 'FontSize',fontsize*.9)
text(72, 16, ['D_{10} = ',num2str(D10, 3),' μm'], 'FontSize',fontsize*.9)
...
position = [0.49 0.28 0.32 0.32];  % [x y width height]
